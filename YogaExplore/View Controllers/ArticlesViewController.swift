...
class ArticlesViewController: UIViewController {
    ...
    fileprivate func getMessage() -> NSAttributedString {
        ...
        let title = NSAttributedString(string: Constants.Generic.articles_screen_title, attributes: [NSAttributedString.Key.font : UIFont.bold(ofSize: 22), NSAttributedString.Key.foregroundColor: UIColor.palova])
